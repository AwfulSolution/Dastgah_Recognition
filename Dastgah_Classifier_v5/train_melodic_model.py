...
from dastgah_v5 import LABELS  # noqa: E402
from dastgah_v5.data import Track, ensure_manifest_and_splits, label_to_index  # noqa: E402
from dastgah_v5.melodic_features import MelodicFeatureConfig, build_track_matrix  # noqa: E402
from dastgah_v5.modeling import MODEL_TYPES, build_model  # noqa: E402
from dastgah_v5.paths import portable_path  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--count_features", action="store_true")
    return p.parse_args()
...
def main() -> None:
    ...
    cfg = MelodicFeatureConfig(
        ...
        count_features=args.count_features,
    )
